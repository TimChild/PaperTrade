...
- `docs/architecture/`: Phase-specific design docs
- `docs/ai-agents/procedures/`: Testing and handoff procedures
...
docs/ai-agents/procedures/          # Still used? Should merge with docs/?
```
