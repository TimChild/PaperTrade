...
- `agent_tasks/progress/2026-01-02_00-40-20_dockerize-backend-frontend.md` - Docker task documentation
- `docs/ai-agents/procedures/playwright_e2e_testing.md` - Testing session that discovered the symlink issue
