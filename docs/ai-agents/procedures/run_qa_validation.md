...
6. **Review**: Check report
   ```bash
   cat agent_tasks/progress/2026-01-02_14-30-00_qa-report.md
   ```
...
- See: `scripts/e2e_validation.py` (WIP)
...
- [docs/ai-agents/procedures/playwright_e2e_testing.md](playwright_e2e_testing.md) - Technical Playwright guide
...
- [ ] Reviewed QA report in agent_tasks/progress/
