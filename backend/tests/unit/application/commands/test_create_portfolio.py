...
class TestCreatePortfolio:
    ...
    def test_valid_creation_succeeds(
        ...
        portfolio = portfolio_repo.get(result.portfolio_id)
    ...
    def test_zero_deposit_raises_error(self, handler):
    ...
    def test_negative_deposit_raises_error(self, handler):
    ...
    def test_empty_name_raises_error(self, handler):
    ...
    def test_whitespace_only_name_raises_error(self, handler):
    ...
    def test_name_too_long_raises_error(self, handler):
    ...
    def test_can_retrieve_created_portfolio(
    ...
    def test_initial_transaction_recorded_correctly(
    ...
    def test_different_currencies_supported(self, handler, transaction_repo):
