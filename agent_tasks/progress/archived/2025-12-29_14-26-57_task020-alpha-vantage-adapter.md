...
- [Architecture Plan: Phase 2](../docs/architecture/20251228_phase2-market-data/implementation-guide.md) - Detailed implementation guide
- [ADR-001: Caching Strategy](../docs/architecture/20251228_phase2-market-data/adr-001-caching-strategy.md) - Tiered caching design
- [ADR-002: Rate Limiting](../docs/architecture/20251228_phase2-market-data/adr-002-rate-limiting.md) - Token bucket algorithm design
