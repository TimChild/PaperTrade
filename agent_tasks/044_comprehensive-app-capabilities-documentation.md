...
1. **Architecture Review**:
   - Read `architecture_plans/` to understand design decisions
...
4. **Known Issues & Limitations**:
   ...
   - Review `agent_progress_docs/` for documented problems
...
2. **Supporting Materials**:
   ...
   - [ ] Manual testing report in `agent_progress_docs/`
...
- Architecture deep-dives (exists in architecture_plans/)
...
- `architecture_plans/phase*.md` - Technical architecture
