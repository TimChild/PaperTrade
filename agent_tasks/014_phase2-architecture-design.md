...
- [architecture_plans/20251227_phase1-backend-mvp/](../architecture_plans/20251227_phase1-backend-mvp/) - Phase 1 design
...
1. **Design Document**: `architecture_plans/20251228_phase2-market-data/design.md`
   - Interface specifications
   - Class diagrams (text-based is fine)
   - Sequence diagrams for key flows
   - Database schema with migrations

2. **ADRs**: `architecture_plans/20251228_phase2-market-data/adr-*.md`
