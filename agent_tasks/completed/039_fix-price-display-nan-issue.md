...
**Discovered During**: Playwright E2E testing session (see `docs/ai-agents/procedures/playwright_e2e_testing.md`)
...
- Testing session: `docs/ai-agents/procedures/playwright_e2e_testing.md`
