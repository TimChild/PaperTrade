...
**Leave unchanged**:
- `agent_tasks/progress/` - historical record
- `docs/architecture/` - historical record
...
- agent_tasks/progress/ (keep historical)
- docs/architecture/ (keep historical)
- .git/ (ignore)
...
- Historical documentation in `agent_tasks/progress/`
